...
def save(args, model, info, k_cnt, l_cnt,dfs):
    # save model
    os.makedirs('checkpointCMERSOFTCrossEntropy', exist_ok=True)
    save_dir = os.path.join('checkpointCMERSOFTCrossEntropy', f'{args.corpus_name}.{args.model.lower()}.{k_cnt}.{l_cnt}')
...
for k_cnt in range(num_kfold):
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch_item in enumerate(train_loader):
            ...
            #outputs=model(**inputs).logits.view(-1, 5)
            outputs=model(**inputs).logits
            #print(outputs)
            softLabel = 1.2

            distances = [[0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32], 
                        [softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32], 
                        [1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32],
                        [1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32], 
                        [1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32], 
                        [1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32, 1e32],
                        [1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32, 1e32],
                        [1e32, 1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32, 1e32],
                        [1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32, 1e32],
                        [1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel, 1e32],
                        [1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0, softLabel],
                        [1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, 1e32, softLabel, 0]]
            distances = torch.tensor(distances).float()
            distances = distances * -1
            for i, distance in enumerate(distances):
                distances[i] = torch.softmax(distance, dim=0)
            distances = (distances.cuda()) * -1
            outputs = torch.log(torch.softmax(outputs, dim=1))
            softlabel = distances[labels]
            loss2 = 0
            for i, sample_out in enumerate(outputs):
                loss2 = loss2 + sample_out.view(1, 12).mm(softlabel[i].view(12, 1))[0][0]
            loss = loss2 / outputs.size(0)
            loss.backward()
