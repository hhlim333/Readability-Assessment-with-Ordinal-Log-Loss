...
def save(args, model, info, k_cnt, l_cnt,dfs):
    # save model
    os.makedirs('checkpointCMTSOFTCrossEntropy', exist_ok=True)
    save_dir = os.path.join('checkpointCMTSOFTCrossEntropy', f'{args.corpus_name}.{args.model.lower()}.{k_cnt}.{l_cnt}')
