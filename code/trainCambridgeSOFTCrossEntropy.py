...
def save(args, model, info, k_cnt, l_cnt,dfs):
    # save model
    os.makedirs('checkpointCambridgeSOFTCrossEntropy', exist_ok=True)
    save_dir = os.path.join('checkpointCambridgeSOFTCrossEntropy', f'{args.corpus_name}.{args.model.lower()}.{k_cnt}.{l_cnt}')
